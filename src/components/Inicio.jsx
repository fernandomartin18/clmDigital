      ...
      <section className="inicio-info-section">
        ...
        <div className="inicio-info-main">
          ...
          <div className="inicio-info-content">
            <p>
              Se trata de unas jornadas anuales sobre sociedad digital en Castilla-La Mancha. En esta cuarta edición la temática indaga en cómo la inteligencia artificial está presente en nuestro día a día.
              <br />
      ...
      <section className="talavera-section">
        ...
        <div className="talavera-content">
          ...
          <div className="talavera-text">
            ...
            <p>
              Talavera de la Reina, aquella que fue llamada Ebora en la antigüedad, destaca por su tradición alfarera de más de 2000 años.<br />
